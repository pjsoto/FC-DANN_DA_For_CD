...
DR_LOCALIZATION = ['55']
DA_TYPES = ['None']
REFERENCE = ['REFERENCE_2018_EPSG4674_R220_63_CVA_OTSU_COS_SIM_Mrg_0_Nsy_0_PRef_0_Met_P-83R-65F1-73']
...
Schedule.append("python " + Train_MAIN_COMMAND + " --classifier_type " + METHODS[0] + " --domain_regressor_type None --DR_Localization " + DR_LOCALIZATION[0] + " --skip_connections False --epochs 100 --batch_size 32 --lr 0.0001 "
                ...
                "--patience 10 --checkpoint_dir checkpoint_tr_CERRADO_MA_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + REFERENCE[0] + " "
...
Schedule.append("python " + Test_MAIN_COMMAND + " --classifier_type " + METHODS[0] + " --domain_regressor_type None --DR_Localization " + DR_LOCALIZATION[0] + " --skip_connections False --batch_size 500 --vertical_blocks 3 "
                ...
                "--phase test --training_type classification --da_type " + DA_TYPES[0] + " --checkpoint_dir checkpoint_tr_CERRADO_MA_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + REFERENCE[0] + " --results_dir results_tr_CERRADO_MA_ts_CERRADO_MA_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + REFERENCE[0] + " "
...
Schedule.append("python " + Metrics_th_MAIN_COMMAND + " --classifier_type " + METHODS[0] + " --domain_regressor_type None --skip_connections False --vertical_blocks 3 "
                ...
                "--compute_ndvi False --phase compute_metrics --training_type classification "
                "--save_result_text False --checkpoint_dir checkpoint_tr_CERRADO_MA_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + REFERENCE[0] + " --results_dir results_tr_CERRADO_MA_ts_CERRADO_MA_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + REFERENCE[0] + " "
                "--dataset Cerrado_MA --images_section Organized/Images/ --reference_section Organized/References/ "
                "--data_type .npy --data_t1_year 2016 --data_t2_year 2017 "
                "--data_t1_name 18_08_2017_image_R220_63 --data_t2_name 21_08_2018_image_R220_63 "
                "--reference_t1_name PAST_REFERENCE_FOR_2018_EPSG4674_R220_63 --reference_t2_name REFERENCE_2018_EPSG4674_R220_63 "
