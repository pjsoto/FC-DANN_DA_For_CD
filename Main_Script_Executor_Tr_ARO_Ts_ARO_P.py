...
REFERENCE = ['REFERENCE_2017_EPSG32620_R232_67_CVA_OTSU_PRIOR_0_COS_SIM_Mrg_0_Nsy_1_PRef_0_HConf_1_Met_P-47R-37F1-42']
PAST_REFERENCE = ['PAST_REFERENCE_FROM_1988_2017_EPSG32620_R232_67_CVA_OTSU_COS_SIM_Mrg_0_Nsy_1_PRef_0_HConf_1_Met_P-47R-37F1-42']
...
for pseudo_labels_coefficient in PSEUDLABELS_COEFFICIENTS:
    ...
    Schedule.append("python " + Train_MAIN_COMMAND + " --classifier_type " + METHODS[0] + " --domain_regressor_type None --DR_Localization " + DR_LOCALIZATION[0] + " --skip_connections False --epochs 100 --batch_size 32 --lr 0.0001 "
                    ...
                    "--patience 10 --checkpoint_dir checkpoint_tr_AMAZON_RO_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + pseudo_labels_coefficient + "_" + REFERENCE[0] + " "
                    ...
                    "--source_data_t1_name 18_07_2016_image_R232_67_RO --source_data_t2_name 21_07_2017_image_R232_67_RO --target_data_t1_name 18_07_2016_image_R232_67_RO --target_data_t2_name 21_07_2017_image_R232_67_RO "
    ...
    Schedule.append("python " + Test_MAIN_COMMAND + " --classifier_type " + METHODS[0] + " --domain_regressor_type None --DR_Localization " + DR_LOCALIZATION[0] + " --skip_connections False --batch_size 500 --vertical_blocks 10 "
                    ...
                    "--phase test --training_type classification --da_type " + DA_TYPES[0] + " --checkpoint_dir checkpoint_tr_AMAZON_RO_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + pseudo_labels_coefficient + "_" + REFERENCE[0] + " --results_dir results_tr_AMAZON_RO_ts_AMAZON_RO_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + pseudo_labels_coefficient + "_" + REFERENCE[0] + " "
    ...
    Schedule.append("python " + Metrics_05_MAIN_COMMAND + " --classifier_type " + METHODS[0] + " --domain_regressor_type None --skip_connections False --vertical_blocks 10 "
                    ...
                    "--save_result_text True --checkpoint_dir checkpoint_tr_AMAZON_RO_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + pseudo_labels_coefficient + "_" + REFERENCE[0] + " --results_dir results_tr_AMAZON_RO_ts_AMAZON_RO_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + pseudo_labels_coefficient + "_" + REFERENCE[0] + " "
                    "--dataset Amazon_RO --images_section Organized/Images/ --reference_section Organized/References/ "
                    "--data_type .npy --data_t1_year 2016 --data_t2_year 2017 "
                    "--data_t1_name 18_07_2016_image_R232_67_RO --data_t2_name 21_07_2017_image_R232_67_RO "
                    "--reference_t1_name PAST_REFERENCE_FROM_1988_2017_EPSG32620_R232_67_RO --reference_t2_name REFERENCE_2017_EPSG32620_R232_67_RO "
    ...
    Schedule.append("python " + Metrics_th_MAIN_COMMAND + " --classifier_type " + METHODS[0] + " --domain_regressor_type None --skip_connections False --vertical_blocks 10 "
                    ...
                    "--compute_ndvi False --phase compute_metrics --training_type classification "
                    "--save_result_text False --checkpoint_dir checkpoint_tr_AMAZON_RO_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + pseudo_labels_coefficient + "_" + REFERENCE[0] + " --results_dir results_tr_AMAZON_RO_ts_AMAZON_RO_" + METHODS[0] + "_" + DA_TYPES[0] + "_" + pseudo_labels_coefficient + "_" + REFERENCE[0] + " "
                    "--dataset Amazon_RO --images_section Organized/Images/ --reference_section Organized/References/ "
                    "--data_type .npy --data_t1_year 2016 --data_t2_year 2017 "
                    "--data_t1_name 18_07_2016_image_R232_67_RO --data_t2_name 21_07_2017_image_R232_67_RO "
                    "--reference_t1_name PAST_REFERENCE_FROM_1988_2017_EPSG32620_R232_67_RO --reference_t2_name REFERENCE_2017_EPSG32620_R232_67_RO "
