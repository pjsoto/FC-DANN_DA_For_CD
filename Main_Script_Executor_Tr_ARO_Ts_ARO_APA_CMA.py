...
REFERENCES = ['REFERENCE_2017_EPSG32620_R232_67_RO']
PAST_REFERENCES = ['PAST_REFERENCE_FROM_1988_2017_EPSG32620_R232_67']
            ...
            for r in range(len(REFERENCES)):
                ...
                for pseudo_labels_coefficient in PSEUDLABELS_COEFFICIENTS:
                    ...
                    Schedule.append("python " + Train_MAIN_COMMAND + " --classifier_type " + method + " --domain_regressor_type FC --DR_Localization " + dr_localization + " --skip_connections False --epochs 100 --batch_size 32 --lr 0.0001 "
                                    ...
                                    "--patience 10 --checkpoint_dir checkpoint_tr_AMAZON_RO_to_AMAZON_PA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                                    ...
                                    "--source_data_t1_name 18_07_2016_image_R232_67_RO --source_data_t2_name 21_07_2017_image_R232_67_RO --target_data_t1_name 02_08_2016_image_R225_62_PA --target_data_t2_name 20_07_2017_image_R225_62_PA "
                                    "--source_reference_t1_name PAST_REFERENCE_FROM_1988_2017_EPSG32620_R232_67 --source_reference_t2_name REFERENCE_2017_EPSG32620_R232_67_RO --target_reference_t1_name " + past_reference + " --target_reference_t2_name " + reference  + " "
