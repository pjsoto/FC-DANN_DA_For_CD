            ...
            for r in range(len(REFERENCES)):
                ...
                for pseudo_labels_coefficient in PSEUDLABELS_COEFFICIENTS:
                    ...
                    Schedule.append("python " + Train_MAIN_COMMAND + " --classifier_type " + method + " --domain_regressor_type FC --DR_Localization " + dr_localization + " --skip_connections False --epochs 100 --batch_size 32 --lr 0.0001 "
                                    ...
                                    "--patience 10 --checkpoint_dir checkpoint_tr_AMAZON_PA_to_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                                    ...
                                    "--source_data_t1_name 02_08_2016_image_R225_62_PA --source_data_t2_name 20_07_2017_image_R225_62_PA --target_data_t1_name 18_07_2016_image_R232_67_RO --target_data_t2_name 21_07_2017_image_R232_67_RO "
                                    "--source_reference_t1_name PAST_REFERENCE_FROM_1988_2017_EPSG4674_R225_62_PA --source_reference_t2_name REFERENCE_2017_EPSG4674_R225_62_PA --target_reference_t1_name " + past_reference + " --target_reference_t2_name " + reference  + " "
                    ...
                    Schedule.append("python " + Test_MAIN_COMMAND + " --classifier_type " + method + " --domain_regressor_type FC --DR_Localization " + dr_localization + " --skip_connections False --batch_size 500 --vertical_blocks 10 "
                                    ...
                                    "--phase test --training_type domain_adaptation --da_type " + da + " --checkpoint_dir checkpoint_tr_AMAZON_PA_to_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_AMAZON_PA_to_AMAZON_RO_ts_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
            ...
            for r in range(len(REFERENCES)):
                ...
                #Tr: MA->PA
                    Schedule.append("python " + Train_MAIN_COMMAND + " --classifier_type " + method + " --domain_regressor_type FC --DR_Localization " + dr_localization + " --skip_connections False --epochs 100 --batch_size 32 --lr 0.0001 "
                                    ...
                                    "--buffer True --source_buffer_dimension_out 2 --source_buffer_dimension_in 0 --target_buffer_dimension_out 2 --target_buffer_dimension_in 0 --porcent_of_last_reference_in_actual_reference 100 "
                                    "--porcent_of_positive_pixels_in_actual_reference_s 2 --porcent_of_positive_pixels_in_actual_reference_t 2 "
                                    "--num_classes 2 --phase train --training_type domain_adaptation --da_type " + da + " --runs 2 --pseudo_labels_coefficient " + pseudo_labels_coefficient + " "
                                    "--patience 10 --checkpoint_dir checkpoint_tr_AMAZON_PA_to_CERRADO_MA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                                    ...
                                    "--source_data_t1_name 02_08_2016_image_R225_62_PA --source_data_t2_name 20_07_2017_image_R225_62_PA --target_data_t1_name 18_08_2017_image_R220_63_MA --target_data_t2_name 21_08_2018_image_R220_63_MA "
                                    "--source_reference_t1_name PAST_REFERENCE_FROM_1988_2017_EPSG4674_R225_62_PA --source_reference_t2_name REFERENCE_2017_EPSG4674_R225_62_PA --target_reference_t1_name " + past_reference + " --target_reference_t2_name " + reference  + " "
                                    "--dataset_main_path "+ Dataset_MAIN_PATH + " "
                                    "--checkpoint_results_main_path "+ Checkpoint_Results_MAIN_PATH + "")
                    ...
                    Schedule.append("python " + Test_MAIN_COMMAND + " --classifier_type " + method + " --domain_regressor_type FC --DR_Localization " + dr_localization + " --skip_connections False --batch_size 500 --vertical_blocks 3 "
                                    ...
                                    "--phase test --training_type domain_adaptation --da_type " + da + " --checkpoint_dir checkpoint_tr_AMAZON_PA_to_CERRADO_MA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_AMAZON_PA_to_CERRADO_MA_ts_CERRADO_MA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                    ...
                    Schedule.append("python " + Metrics_05_MAIN_COMMAND + " --classifier_type " + method + " --domain_regressor_type FC --skip_connections False --vertical_blocks 3 "
                                    ...
                                    "--compute_ndvi False --phase compute_metrics --training_type classification "
                                    "--save_result_text True --checkpoint_dir checkpoint_tr_AMAZON_PA_to_CERRADO_MA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_AMAZON_PA_to_CERRADO_MA_ts_CERRADO_MA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                                    "--dataset Cerrado_MA --images_section Organized/Images/ --reference_section Organized/References/ "
                                    "--data_type .npy --data_t1_year 2016 --data_t2_year 2017 "
                                    "--data_t1_name 18_08_2017_image_R220_63_MA --data_t2_name 21_08_2018_image_R220_63_MA "
                                    "--reference_t1_name PAST_REFERENCE_FOR_2018_EPSG4674_R220_63_MA --reference_t2_name REFERENCE_2018_EPSG4674_R220_63_MA "
                    ...
                    Schedule.append("python " + Metrics_th_MAIN_COMMAND + " --classifier_type " + method + " --domain_regressor_type FC --skip_connections False --vertical_blocks 3 "
                                    ...
                                    "--compute_ndvi False --phase compute_metrics --training_type classification "
                                    "--save_result_text False --checkpoint_dir checkpoint_tr_AMAZON_PA_to_CERRADO_MA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_AMAZON_PA_to_CERRADO_MA_ts_CERRADO_MA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                                    "--dataset Cerrado_MA --images_section Organized/Images/ --reference_section Organized/References/ "
                                    "--data_type .npy --data_t1_year 2016 --data_t2_year 2017 "
                                    "--data_t1_name 18_08_2017_image_R220_63_MA --data_t2_name 21_08_2018_image_R220_63_MA "
                                    "--reference_t1_name PAST_REFERENCE_FOR_2018_EPSG4674_R220_63_MA --reference_t2_name REFERENCE_2018_EPSG4674_R220_63_MA "
