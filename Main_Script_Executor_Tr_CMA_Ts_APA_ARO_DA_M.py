...
#                                    "--patience 10 --checkpoint_dir checkpoint_tr_CERRADO_MA_to_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
...
#                                    "--source_data_t1_name 18_08_2017_image_R220_63_MA --source_data_t2_name 21_08_2018_image_R220_63_MA --target_data_t1_name 18_07_2016_image_R232_67_RO --target_data_t2_name 21_07_2017_image_R232_67_RO "
#                                    "--source_reference_t1_name PAST_REFERENCE_FOR_2018_EPSG4674_R220_63_MA --source_reference_t2_name REFERENCE_2018_EPSG4674_R220_63_MA --target_reference_t1_name " + past_reference + " --target_reference_t2_name " + reference  + " "
...
#                                    "--phase test --training_type domain_adaptation --da_type " + da + " --checkpoint_dir checkpoint_tr_CERRADO_MA_to_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_CERRADO_MA_to_AMAZON_RO_ts_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
...
#                                    "--save_result_text True --checkpoint_dir checkpoint_tr_CERRADO_MA_to_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_CERRADO_MA_to_AMAZON_RO_ts_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
#                                    "--dataset Amazon_RO --images_section Organized/Images/ --reference_section Organized/References/ "
...
#                                    "--compute_ndvi False --phase compute_metrics --training_type classification "
#                                    "--save_result_text False --checkpoint_dir checkpoint_tr_CERRADO_MA_to_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_CERRADO_MA_to_AMAZON_RO_ts_AMAZON_RO_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
#                                    "--dataset Amazon_RO --images_section Organized/Images/ --reference_section Organized/References/ "
#                                    "--data_type .npy --data_t1_year 2016 --data_t2_year 2017 "
#                                    "--data_t1_name 18_07_2016_image_R232_67_RO --data_t2_name 21_07_2017_image_R232_67_RO "
#                                    "--reference_t1_name PAST_REFERENCE_FROM_1988_2017_EPSG32620_R232_67_RO --reference_t2_name REFERENCE_2017_EPSG32620_R232_67_RO "
...
REFERENCES = ['REFERENCE_2017_EPSG4674_R225_62_CVA_OTSU_PRIOR_0_COS_SIM_Mrg_0_Nsy_1_PRef_0_HConf_1_Met_P-77R-43F1-55']
PAST_REFERENCES = ['PAST_REFERENCE_FROM_1988_2017_EPSG4674_R225_62_CVA_OTSU_COS_SIM_Mrg_0_Nsy_1_PRef_0_HConf_1_Met_P-77R-43F1-55']
for dr_localization in DR_LOCALIZATION:
    for method in METHODS:
        for da in DA_TYPES:
            for r in range(len(REFERENCES)):
                ...
                for pseudo_labels_coefficient in PSEUDLABELS_COEFFICIENTS:
                    ...
                    #                "--patience 10 --checkpoint_dir checkpoint_tr_CERRADO_MA_to_AMAZON_PA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                    ...
                    #                "--data_type .npy --source_data_t1_year 2017 --source_data_t2_year 2018 --target_data_t1_year 2016 --target_data_t2_year 2017 "
                    #                "--source_data_t1_name 18_08_2017_image_R220_63_MA --source_data_t2_name 21_08_2018_image_R220_63_MA --target_data_t1_name 02_08_2016_image_R225_62_PA --target_data_t2_name 20_07_2017_image_R225_62_PA "
                    #                "--source_reference_t1_name PAST_REFERENCE_FOR_2018_EPSG4674_R220_63_MA --source_reference_t2_name REFERENCE_2018_EPSG4674_R220_63_MA --target_reference_t1_name " + past_reference + " --target_reference_t2_name " + reference  + " "
                    #                "--dataset_main_path "+ Dataset_MAIN_PATH + " "
                    #                "--checkpoint_results_main_path "+ Checkpoint_Results_MAIN_PATH + "")
                    ...
                    #                "--phase test --training_type domain_adaptation --da_type " + da + " --checkpoint_dir checkpoint_tr_CERRADO_MA_to_AMAZON_PA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_CERRADO_MA_to_AMAZON_PA_ts_AMAZON_PA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                    ...
                    #                "--buffer_dimension_out 2 --buffer_dimension_in 0 --eliminate_regions True --area_avoided 69 "
                    #                "--compute_ndvi False --phase compute_metrics --training_type classification "
                    #                "--save_result_text True --checkpoint_dir checkpoint_tr_CERRADO_MA_to_AMAZON_PA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_CERRADO_MA_to_AMAZON_PA_ts_AMAZON_PA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                    #                "--dataset Amazon_PA --images_section Organized/Images/ --reference_section Organized/References/ "
                    #                "--data_type .npy --data_t1_year 2016 --data_t2_year 2017 "
                    #                "--data_t1_name 02_08_2016_image_R225_62_PA --data_t2_name 20_07_2017_image_R225_62_PA "
                    #                "--reference_t1_name PAST_REFERENCE_FROM_1988_2017_EPSG4674_R225_62_PA --reference_t2_name REFERENCE_2017_EPSG4674_R225_62_PA "
                    ...
                    Schedule.append("python " + Metrics_th_MAIN_COMMAND + " --classifier_type " + method + " --domain_regressor_type FC --skip_connections False --vertical_blocks 5 "
                                    ...
                                    "--buffer_dimension_out 2 --buffer_dimension_in 0 --eliminate_regions True --area_avoided 69 --Npoints 100 "
                                    "--compute_ndvi False --phase compute_metrics --training_type classification "
                                    "--save_result_text False --checkpoint_dir checkpoint_tr_CERRADO_MA_to_AMAZON_PA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " --results_dir results_tr_CERRADO_MA_to_AMAZON_PA_ts_AMAZON_PA_" + method + "_" + da + "_" + pseudo_labels_coefficient + "_" + reference + " "
                                    "--dataset Amazon_PA --images_section Organized/Images/ --reference_section Organized/References/ "
                                    "--data_type .npy --data_t1_year 2016 --data_t2_year 2017 "
                                    "--data_t1_name 02_08_2016_image_R225_62_PA --data_t2_name 20_07_2017_image_R225_62_PA "
                                    "--reference_t1_name PAST_REFERENCE_FROM_1988_2017_EPSG4674_R225_62_PA --reference_t2_name REFERENCE_2017_EPSG4674_R225_62_PA "
